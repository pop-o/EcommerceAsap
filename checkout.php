...
if(isset($_POST['order'])){
   ...
   if($check_cart->rowCount() > 0){
      ...
      if ($method == 'Khalti') {
         // Handle Khalti payment here
         $khalti_payment_token = $_POST['khalti_payment_token'];

         // Verify the Khalti payment using the token
         // You should implement a server-side verification here using Khalti API

         // Assuming verification is successful, proceed with order placement
